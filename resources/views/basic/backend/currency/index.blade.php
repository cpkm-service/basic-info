...
<div class="block block-rounded">
    <div class="block-header block-header-default">
        ...
        <a href="{{ route('backend.basic.currency.create') }}" class="btn btn-primary create">{{ __('create') }}</a>
    </div>
...
<script type="text/javascript">
    var url = "{{route('backend.basic.currency.index',[],false)}}";
    var search = makeDataTable(
        ...
        [
            ...
            },
            {
                ...
                title: "{{__('basic::backend.currencies.name')}}"
            },
            {
                data: "code",
                className: "text-md-center",
                title: "{{__('basic::backend.currencies.code')}}"
            },
            {
                data: "id",
                className: "text-md-center",
